...
<title>MLSU College Portal</title>
 <link rel="shortcut icon" href="imgages/logo.ico">
<meta charset="utf-8">
...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      ...
      <a href="" title="" rel="home" target="_blank" style="background-color:rgba(255,255,255,1.00); color:rgba(0,0,0,1.00)"><img src="" alt=""> <h1></br>MLSU College Portal</a></h1>
