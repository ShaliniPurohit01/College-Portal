...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      ...
      <a href="" title="" rel="home" target="_blank" style="background-color:rgba(255,255,255,1.00); color:rgba(0,0,0,1.00)"><img src="images/it_logo.jpg" alt=""> <h1></br></a></h1>
