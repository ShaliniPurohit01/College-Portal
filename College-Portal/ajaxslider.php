...
<table width="200" border="1">
          <tr>
            ...
            <td width="76%">
            <input type="title" name="slidertitle" id="newstitle" 
			style="width:400px;height:35px;" value="<?php echo $rsslider["slidertitle"];?>" /></td>
          </tr>
          <tr>
            <td>Image</td>
          ...
          <tr>
            <td>Description</td>
            <td><textarea name="description" id="description" rows="10" cols="50">
			<?php echo $rsslider["description"];?></textarea></td>
          </tr>
          <tr>
