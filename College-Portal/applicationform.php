...
{      
	$dt= date("Y-m-d");
$sql="INSERT INTO applicationform (regndate,admissionnumber,admissiondate,course_id,
		semester,firstname,lastname,dob,bloodgroup,gender,placeofbirth,parentsinfo,
		father,mother,fathersoccupation,mothersoccupation,cont_address,state,district,
		taluk,citytown,country,pincode,mobileno,emailid,alternatecontact,religion,
		studcategory,studentcaste,mothertongue,nationality,paidfee,othlangx, othlangxii,
		othvaccourse, othphysicchallenge, othexservice, othtenant, othsports, othnccnss,
		othschoolastst, othhostelacc, othinsmendium, place,status)VALUES('$dt',
		'$_POST[admissionnumber]','$_POST[admissiondate]','$_POST[course]',
		'$_POST[semester]','$_POST[firstname]','$_POST[lastname]','$_POST[dob]',
		'$_POST[bloodgroup]','$_POST[gender]','$_POST[placeofbirth]',
		'$_POST[parentsinfo]','$_POST[fathername]','$_POST[mothername]',
		'$_POST[fathersoccupation]','$_POST[mothersoccupation]','$_POST[contactaddress]',
		'$_POST[state]','$_POST[district]','$_POST[taluk]','$_POST[citytownsuburb]',
		'$_POST[country]','$_POST[postalzipcode]','$_POST[mobilenumber]',
		'$_POST[email]','$_POST[alternatecontactnumber]','$_POST[studentreligion]',
		'$_POST[studentcategory]','$_POST[studentcaste]','$_POST[mothertoungue]',
		'$_POST[nationality]','$_POST[paidfee]','$_POST[langstudiedxeng]',
		'$_POST[langstudiedxiieng]','$_POST[vaccourse]','$_POST[phychal]',
		'$_POST[exservice]','$_POST[guardianoccupation]','$_POST[sports]',
		'$_POST[NSSNCC]','$_POST[nameandlocation]','$_POST[accommodation]','$_POST[medium]',
		'$_POST[place]','Active')";
...
$noattempts = $_POST["noattempts"];
	...
	for($cn=0; $cn<count($_POST["sub"]); $cn++)
	{
	$sql="INSERT INTO student_qualification(application_no, subject, max_mark, marks_obt,
		no_of_attempts) VALUES ('$insid','$sub[$cn]','$maxmark[$cn]','$marksobtained[$cn]',
		'$noattempts[$cn]')";
		if(!$qsql=mysqli_query($con,$sql))
		{
			echo mysqli_error($con);
...
No</td>
        ...
        <tr style="background-color:#CFF">
          <td height="58">Are you a Son/Daughter of Ex-Serviceman of Rajasthan origin?</td>
